...
public abstract class BaseProcessService
{
    ...
    public List<FlowElementVo> getProcessNodes(String modelkey)
    {
        ...
        {
           List<FlowElementVo> flowElementVoList = getProcessNodes(flowElement);
           if(CollectionUtils.isNotEmpty(flowElementVoList))
           {
               flowNodeVos.addAll(flowElementVoList);
           }
        }
    ...
    public List<FlowElementVo> getProcessNodes(FlowElement flowElement)
    {
        List<String> assigneeList = null;
        List<FlowElementVo> flowNodeVos = new ArrayList<>();
        ...
        if (flowElement instanceof SubProcess)
        {
            ...
            for (FlowElement subElement : subFlowElements)
            {
                ...
                {
                    List<FlowElementVo> flowElementVoList= getProcessNodes(subElement);
                    flowNodeVos.addAll(flowElementVoList);
                }
            }
        }
