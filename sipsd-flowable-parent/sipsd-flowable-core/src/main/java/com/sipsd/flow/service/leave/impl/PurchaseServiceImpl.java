package com.sipsd.flow.service.leave.impl;
...
import com.sipsd.flow.common.StringTools;
import com.sipsd.flow.common.page.PageModel;
import com.sipsd.flow.common.page.Query;
import com.sipsd.flow.dao.leave.IPurchaseDao;
...
public class PurchaseServiceImpl implements IPurchaseService {
	...
	@Override
	public PageModel<Purchase> getPagerModelByQuery(Purchase purchase, Query query)
			throws Exception {
		PageHelper.startPage(query.getPageIndex(),query.getPageSize());
		Page<Purchase> page = this.purchaseDao.getPagerModelByQuery(purchase);
		return new PageModel<Purchase>(page);
	}
