...
public class LunarInfo {
	...
	public static int getDay(Date date) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		int day = cal.get(Calendar.DAY_OF_YEAR);//一年中的第几周
		return  day;
	}
	...
	public static int getDayOfWeek(Date date) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		int day = cal.get(Calendar.DAY_OF_WEEK);//一年中的第几周
		return  day;
	}
	...
	public static int getDayOfMonth(Date date) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		int day = cal.get(Calendar.DAY_OF_MONTH);//一年中的第几周
		return  day;
	}
	/**
	 * 转换日期yyMMdd
	 ...
	 * @return 日期字符串
	 */
	public static Date FormatToDate(String dateCode,String pattern) throws Exception {
		SimpleDateFormat sdf = new SimpleDateFormat(pattern);
		return  sdf.parse(dateCode);
	}
}