...
public interface ModelRepository {
    ...
    List<Model> findByTenantModelType(Integer modelType, String tenantId,String sort);
    List<Model> findByTenantModelTypeAndFilter(Integer modelType, String tenantId,String filter, String sort);
